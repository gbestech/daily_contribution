...
const AdminMembers = () => {
  ...
  const handleAddMember = async (e) => {
    ...
    try {
      ...
      const hashedPassword = await hashPassword(newMember.password);
  ...
  const handleUpdateMember = async (e) => {
    ...
    if (editPassword.trim()) {
      const hashedPassword = await hashPassword(editPassword.trim());
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          editPassword.trim()
            ? "✅ Member updated and password changed successfully!"
  ...
  return (
    ...
    >
      ...
      {/* Add Member Modal - WITH ROLE FIELD */}
      {showAddModal && (
      ...
      {/* Edit Member Modal - WITH ROLE FIELD */}
